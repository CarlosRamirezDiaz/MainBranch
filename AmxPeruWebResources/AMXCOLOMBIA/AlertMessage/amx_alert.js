...
Alert._prefix = "amx_"; // Change this if you have your own solution prefix (as long as the file structure's the same)
...
Alert.showLoading = function (url, message, width, height) {
    Alert.show(message, null, [], "LOADING", width, height, url, true);
}
