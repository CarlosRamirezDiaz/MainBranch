...
{
    public class AmxGetCustomerAddress : XrmAwareCodeActivity
    {
        #region Input/Output Arguments
        public InArgument<Model.cmtDireccionRequestDto> CustomerAddressRequest { get; set; }
        ...
        protected override void Execute(XrmDataContext dataContext, CodeActivityContext context)
        {
            ...
            if (request != null)
            {
                jsonResponseStr = new AmxGetCustomerAddressBusiness()
                    .GetCustomerAddress(request, MGLUser.Get(context), HostUrl.Get(context), HeaderRequestStr.Get(context), ContextProvider.OrganizationService);
            }
