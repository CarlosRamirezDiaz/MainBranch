...
{
    public class GetAvailableOfferConfigurationWithPrices : XrmAwareCodeActivity
    {
        ...
        protected override void Execute(XrmDataContext dataContext, CodeActivityContext context)
        {
            ...
            var configurations = offeringPriceConfigurationList.Entities.Where(a => productOfferingIds.Contains(((EntityReference)(a.Attributes["amxperu_productoffering"])).Id));
            ...
            {                
                ...
                model.OfferingId = Convert.ToString(((EntityReference)(item.Attributes["amxperu_productoffering"])).Id);
