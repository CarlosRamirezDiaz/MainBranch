...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA {
    ...
    public partial class AMXRetrieveCustomerAddressMGLTechDetails : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<AmxPeruPSBActivities.AMXCOLOMBIA.Model.AddressMGLtechDetails> _addressMGLRequest;
...
partial void AfterInitializeComponent();
        ...
        public AMXRetrieveCustomerAddressMGLTechDetails() {
            this.InitializeComponent();
        }
        
        public System.Activities.InArgument<AmxPeruPSBActivities.AMXCOLOMBIA.Model.AddressMGLtechDetails> addressMGLRequest {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AMXRetrieveCustomerAddressMGLTechDetails).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AMXRetrieveCustomerAddressMGLTechDetails));
        ...
        private string FindResource() {
            string[] resources = typeof(AMXRetrieveCustomerAddressMGLTechDetails).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AMXRetrieveCustomerAddressMGLTechDetails.g.xaml") || resource.Equals("AMXRetrieveCustomerAddressMGLTechDetails.g.xaml"))) {
                    return resource;
                }
            }
