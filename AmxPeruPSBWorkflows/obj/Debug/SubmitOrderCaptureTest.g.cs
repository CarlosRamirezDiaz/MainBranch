...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA {
    ...
    public partial class SubmitOrderCaptureTest : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SubmitOrderCaptureTest).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SubmitOrderCaptureTest));
        ...
        private string FindResource() {
            string[] resources = typeof(SubmitOrderCaptureTest).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SubmitOrderCaptureTest.g.xaml") || resource.Equals("SubmitOrderCaptureTest.g.xaml"))) {
                    return resource;
                }
            }
