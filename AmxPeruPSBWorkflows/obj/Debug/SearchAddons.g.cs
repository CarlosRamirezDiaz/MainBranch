...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class SearchAddons : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _customerId;
        
        private System.Activities.InArgument<string> _offeringId;
        
        private System.Activities.OutArgument<AmxPeruPSBActivities.Model.ProductOffering[]> _productOfferingList;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<string> offeringId {
            get {
        ...
        public System.Activities.OutArgument<AmxPeruPSBActivities.Model.ProductOffering[]> productOfferingList {
            get {
                return this._productOfferingList;
            }
            set {
                this._productOfferingList = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SearchAddons).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SearchAddons));
        ...
        private string FindResource() {
            string[] resources = typeof(SearchAddons).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SearchAddons.g.xaml") || resource.Equals("SearchAddons.g.xaml"))) {
                    return resource;
                }
            }
