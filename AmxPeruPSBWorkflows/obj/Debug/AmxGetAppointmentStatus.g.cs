...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA.IVR {
    ...
    public partial class AmxGetAppointmentStatus : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public AmxGetAppointmentStatus() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxGetAppointmentStatus).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxGetAppointmentStatus));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxGetAppointmentStatus).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxGetAppointmentStatus.g.xaml") || resource.Equals("AmxGetAppointmentStatus.g.xaml"))) {
                    return resource;
                }
            }
