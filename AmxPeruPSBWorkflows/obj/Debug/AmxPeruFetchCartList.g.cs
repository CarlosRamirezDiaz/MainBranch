...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class AmxPeruFetchCartList : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxPeruFetchCartList).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxPeruFetchCartList));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxPeruFetchCartList).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxPeruFetchCartList.g.xaml") || resource.Equals("AmxPeruFetchCartList.g.xaml"))) {
                    return resource;
                }
            }
