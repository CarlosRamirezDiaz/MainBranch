...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA {
    ...
    public partial class AmxGetCustomerAddressHhpp : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<AmxPeruPSBActivities.AMXCOLOMBIA.Model.AmxAddressMGLHhppRequest> _addressMGLRequest;
...
partial void AfterInitializeComponent();
        ...
        public AmxGetCustomerAddressHhpp() {
            this.InitializeComponent();
        }
        
        public System.Activities.InArgument<AmxPeruPSBActivities.AMXCOLOMBIA.Model.AmxAddressMGLHhppRequest> addressMGLRequest {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxGetCustomerAddressHhpp).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxGetCustomerAddressHhpp));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxGetCustomerAddressHhpp).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxGetCustomerAddressHhpp.g.xaml") || resource.Equals("AmxGetCustomerAddressHhpp.g.xaml"))) {
                    return resource;
                }
            }
