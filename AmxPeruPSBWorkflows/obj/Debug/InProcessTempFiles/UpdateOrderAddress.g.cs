...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA {
    ...
    public partial class UpdateOrderAddress : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(UpdateOrderAddress).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(UpdateOrderAddress));
        ...
        private string FindResource() {
            string[] resources = typeof(UpdateOrderAddress).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".UpdateOrderAddress.g.xaml") || resource.Equals("UpdateOrderAddress.g.xaml"))) {
                    return resource;
                }
            }
