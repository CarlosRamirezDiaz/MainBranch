...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class AmxCoGetFileDocumentaryManager : System.Activities.Presentation.ActivityDesigner, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public AmxCoGetFileDocumentaryManager() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxCoGetFileDocumentaryManager).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxCoGetFileDocumentaryManager));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxCoGetFileDocumentaryManager).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxCoGetFileDocumentaryManager.g.xaml") || resource.Equals("AmxCoGetFileDocumentaryManager.g.xaml"))) {
                    return resource;
                }
            }
