...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class UpdateOrderItemsForMultiPlay : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public UpdateOrderItemsForMultiPlay() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(UpdateOrderItemsForMultiPlay).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(UpdateOrderItemsForMultiPlay));
        ...
        private string FindResource() {
            string[] resources = typeof(UpdateOrderItemsForMultiPlay).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".UpdateOrderItemsForMultiPlay.g.xaml") || resource.Equals("UpdateOrderItemsForMultiPlay.g.xaml"))) {
                    return resource;
                }
            }
