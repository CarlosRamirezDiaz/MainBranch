...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class WizardBasedTraining : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(WizardBasedTraining).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(WizardBasedTraining));
        ...
        private string FindResource() {
            string[] resources = typeof(WizardBasedTraining).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".WizardBasedTraining.g.xaml") || resource.Equals("WizardBasedTraining.g.xaml"))) {
                    return resource;
                }
            }
