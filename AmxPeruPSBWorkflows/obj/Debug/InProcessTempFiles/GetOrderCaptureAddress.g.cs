...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class GetOrderCaptureAddress : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _orderCaptureId;
        
        private System.Activities.OutArgument<string> _addressId;
        
        private System.Activities.OutArgument<string> _addressName;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<string> addressId {
            get {
        ...
        public System.Activities.OutArgument<string> addressName {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(GetOrderCaptureAddress).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(GetOrderCaptureAddress));
        ...
        private string FindResource() {
            string[] resources = typeof(GetOrderCaptureAddress).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".GetOrderCaptureAddress.g.xaml") || resource.Equals("GetOrderCaptureAddress.g.xaml"))) {
                    return resource;
                }
            }
