...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class AmxPeruSetOrderMilestone : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public AmxPeruSetOrderMilestone() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxPeruSetOrderMilestone).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxPeruSetOrderMilestone));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxPeruSetOrderMilestone).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxPeruSetOrderMilestone.g.xaml") || resource.Equals("AmxPeruSetOrderMilestone.g.xaml"))) {
                    return resource;
                }
            }
