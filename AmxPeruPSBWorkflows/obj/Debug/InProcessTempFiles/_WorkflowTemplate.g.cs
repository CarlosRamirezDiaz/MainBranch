...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA {
    ...
    public partial class _WorkflowTemplate : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(_WorkflowTemplate).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(_WorkflowTemplate));
        ...
        private string FindResource() {
            string[] resources = typeof(_WorkflowTemplate).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains("._WorkflowTemplate.g.xaml") || resource.Equals("_WorkflowTemplate.g.xaml"))) {
                    return resource;
                }
            }
