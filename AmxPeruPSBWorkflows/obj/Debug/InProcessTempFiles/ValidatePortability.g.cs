...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class ValidatePortability : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ValidatePortability).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ValidatePortability));
        ...
        private string FindResource() {
            string[] resources = typeof(ValidatePortability).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ValidatePortability.g.xaml") || resource.Equals("ValidatePortability.g.xaml"))) {
                    return resource;
                }
            }
