...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class AmxPeruCancelCart : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxPeruCancelCart).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxPeruCancelCart));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxPeruCancelCart).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxPeruCancelCart.g.xaml") || resource.Equals("AmxPeruCancelCart.g.xaml"))) {
                    return resource;
                }
            }
