...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class AmxCoRevertCartPrices : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _orderCaptureId;
        
        private System.Activities.InArgument<bool> _isRemovedItemPermanencia;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<bool> isRemovedItemPermanencia {
            get {
                return this._isRemovedItemPermanencia;
            }
            set {
                this._isRemovedItemPermanencia = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxCoRevertCartPrices).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxCoRevertCartPrices));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxCoRevertCartPrices).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxCoRevertCartPrices.g.xaml") || resource.Equals("AmxCoRevertCartPrices.g.xaml"))) {
                    return resource;
                }
            }
