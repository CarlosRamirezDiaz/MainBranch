...
namespace AmxPeruPSBWorkflows.AMX_COLOMBIA {
    ...
    public partial class UpdateOrderItemBillingAccount : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _billingAccountId;
...
partial void AfterInitializeComponent();
        ...
        public UpdateOrderItemBillingAccount() {
            this.InitializeComponent();
        }
        
        public System.Activities.InArgument<string> billingAccountId {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(UpdateOrderItemBillingAccount).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(UpdateOrderItemBillingAccount));
        ...
        private string FindResource() {
            string[] resources = typeof(UpdateOrderItemBillingAccount).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".UpdateOrderItemBillingAccount.g.xaml") || resource.Equals("UpdateOrderItemBillingAccount.g.xaml"))) {
                    return resource;
                }
            }
