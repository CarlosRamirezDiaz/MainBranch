...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class AmxPeruAmendOrderWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public AmxPeruAmendOrderWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxPeruAmendOrderWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxPeruAmendOrderWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxPeruAmendOrderWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxPeruAmendOrderWorkflow.g.xaml") || resource.Equals("AmxPeruAmendOrderWorkflow.g.xaml"))) {
                    return resource;
                }
            }
