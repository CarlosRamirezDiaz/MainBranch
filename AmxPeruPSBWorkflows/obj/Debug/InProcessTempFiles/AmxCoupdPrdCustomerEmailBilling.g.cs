...
namespace AmxPeruPSBWorkflows.ClaroESB {
    ...
    public partial class AmxCoupdPrdCustomerEmailBilling : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public AmxCoupdPrdCustomerEmailBilling() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxCoupdPrdCustomerEmailBilling).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxCoupdPrdCustomerEmailBilling));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxCoupdPrdCustomerEmailBilling).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxCoupdPrdCustomerEmailBilling.g.xaml") || resource.Equals("AmxCoupdPrdCustomerEmailBilling.g.xaml"))) {
                    return resource;
                }
            }
