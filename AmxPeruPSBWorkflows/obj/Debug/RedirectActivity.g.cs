...
namespace AmxPeruPSBWorkflows {
    ...
    public partial class RedirectActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RedirectActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RedirectActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(RedirectActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RedirectActivity.g.xaml") || resource.Equals("RedirectActivity.g.xaml"))) {
                    return resource;
                }
            }
