...
namespace AmxPeruPSBWorkflows.ClaroESB {
    ...
    public partial class AmxCoDigiturnoUpdateUserTurn : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public AmxCoDigiturnoUpdateUserTurn() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AmxCoDigiturnoUpdateUserTurn).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AmxCoDigiturnoUpdateUserTurn));
        ...
        private string FindResource() {
            string[] resources = typeof(AmxCoDigiturnoUpdateUserTurn).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AmxCoDigiturnoUpdateUserTurn.g.xaml") || resource.Equals("AmxCoDigiturnoUpdateUserTurn.g.xaml"))) {
                    return resource;
                }
            }
