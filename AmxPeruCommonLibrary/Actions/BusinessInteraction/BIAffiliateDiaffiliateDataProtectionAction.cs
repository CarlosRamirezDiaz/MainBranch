...
{
    public class BIAffiliateDiaffiliateDataProtectionAction : BusinessInteractionAction<Entity>, IBIAffiliateDiaffiliateDataProtectionAction
    {
        /// <summary>
        ...
        /// The context.
        /// </param>
        public BIAffiliateDiaffiliateDataProtectionAction(IActionContext context)
            : base(context)
        {
        }
    }

    public interface IBIAffiliateDiaffiliateDataProtectionAction : IBusinessBase
    {
    }
}
