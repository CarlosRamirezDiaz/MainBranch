...
using Ericsson.ETELCRM.Plugins.BusinessInteractions;
...
{
    public class BIAffiliateDisaffiliatetoWhitePagePlugIn  : BusinessInteractionPlugin<IBIAffiliateDiaffiliateDataProtectionAction>, IPlugin
    {
